...
// Returns food names in user's native language to avoid English leaking into results
function getLocalizedDefaultPortions(countryCode: string): Record<string, { name: string; grams: number; category: string }> {
  // Brazil / Portuguese
