# 📋 INSTRUÇÃO FINAL - EXECUTAR SQL MANUALMENTE

## ⚠️ **NÃO CONSEGUI EXECUTAR AUTOMATICAMENTE**

As ferramentas CLI não permitem execução direta de SQL no banco remoto sem Docker. Você precisa executar manualmente.
...
https://supabase.com/dashboard/project/onzdkpqtzfxzcdyxczkn/sql

## ✅ **APÓS EXECUTAR, TESTE:**

1. App → Chat → "o médico falou que não sou mais intolerante a lactose"
2. IA pergunta confirmação
3. Responda "sim"
4. ✅ Lactose deve ser removida

---

**Execute o SQL e me avise o resultado!**
