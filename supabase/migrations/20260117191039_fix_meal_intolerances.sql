...
-- Adicionar 'egg' ao blocked_for_intolerances de refeições com ovo
-- Adicionar 'gluten' ao blocked_for_intolerances de refeições com pão francês
...
-- 3. Atualizar refeições com pão francês (glúten) no nome
UPDATE meal_combinations
SET blocked_for_intolerances = 
  CASE 
