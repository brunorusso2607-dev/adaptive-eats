...
CREATE INDEX idx_ingredient_pool_alternative ON public.ingredient_pool(is_alternative);
CREATE INDEX idx_ingredient_pool_country ON public.ingredient_pool(country_code);
CREATE INDEX idx_ingredient_pool_safe_for ON public.ingredient_pool USING GIN(safe_for_intolerances);
CREATE INDEX idx_ingredient_pool_replaces ON public.ingredient_pool USING GIN(replaces_ingredients);
...
-- Anyone can view active ingredients
...
CREATE POLICY "Admins can manage ingredient_pool"
  ON public.ingredient_pool
  FOR ALL
  USING (
    EXISTS (
