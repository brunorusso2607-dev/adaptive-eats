-- FINAL MIGRATION COMPLETE - Skip problematic canonical_ingredients
-- Apply only essential fixes for profiles and subscriptions
...
-- Skip canonical_ingredients policy - already exists
