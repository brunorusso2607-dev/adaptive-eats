...
export const INTOLERANCE_MEAL_POOL: IntolerancePoolType = {
  ...
  'gluten': {
    'cafe_manha': [
      ...
      'Tapioca com atum e cream cheese',
      ...
      'Tapioca com queijo coalho grelhado',
...
// Obtém sugestões seguras para múltiplas intolerâncias
export function getSafeMealSuggestions(
  ...
  // Para múltiplas intolerâncias, usa a primeira como base
  // Em implementação futura, poderia fazer interseção
  const primaryIntolerance = intolerances[0];
  return getMealsFromIntolerancePool(primaryIntolerance, mealType, count);
}
