...
-- Removed partial index with now() - not allowed in PostgreSQL
-- Using simple index instead
CREATE INDEX IF NOT EXISTS idx_pending_confirmations_user_expires 
...
-- This ensures we don't accumulate too many expired records
