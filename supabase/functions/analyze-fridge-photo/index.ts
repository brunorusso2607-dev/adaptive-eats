...
const PROCESSED_FOOD_KEYWORDS = [
  ...
  'petit gateau', 'pastel de nata', 'quiche', 'pão de mel', 'affogato',
  'scone', 'danish', 'cinnamon roll', 'macaron', 'blondie', 'pavê',
  'trifle', 'banana split', 'sundae',
  // Embutidos e processados
  'salsicha', 'linguiça', 'mortadela', 'presunto', 'nugget', 'empanado',
  'almôndega', 'croquete', 'bolinho', 'isca',
  // Salgadinhos
  ...
  'pad thai', 'tom yum', 'satay', 'curry', 'pho', 'banh mi',
