-- FINAL COMPLETE FIX V2 - All essential fixes in one migration
-- This resolves "Database error creating new user" and sets up 31-day plan
...
-- Fix canonical_ingredients policy issue - skip if table doesn't exist
DO $$
BEGIN
    IF EXISTS (
