...
async function executeSQL() {
  try {
    ...
    // Usar POST direto para a REST API com service role key
    const response = await fetch('https://onzdkpqtzfxzcdyxczkn.supabase.co/rest/v1/', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer cd201337eefbeedb5088e1affe2e26cb191b40db620a237434dbe86241d35714',
        'apikey': 'cd201337eefbeedb5088e1affe2e26cb191b40db620a237434dbe86241d35714',
